      ...
      if (gameState === 'trackSelect') {
        return (
          <div className="min-h-screen detective-bg flex flex-col items-center p-6 pt-12">
            <button onClick={() => setGameState('cover')} className="self-start mb-6 font-bold bg-yellow-400/80 text-gray-900 px-4 py-2 rounded-full border-2 border-yellow-600">← Voltar</button>
